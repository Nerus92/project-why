...
TEST(passwordsTests, testReadFromFile) {
    char test_file_content[200];
    strcpy(test_file_content, "caesar:50zPJlUFIYY0o\n"
            "cs50:50gyRGMzn6mi6\n"
    ...
    computed_file_content = (char *) malloc(sizeof(char) * 193);
    strcpy(computed_file_content, "caesar:50zPJlUFIYY0o\n"
            "cs50:50gyRGMzn6mi6\n"
            "jharvard:50yoN9fp966dU\n"
            "malan:HA610l/.LeOak\n"
            "nate:50AcIG/VnV3D2\n"
...
//    read_file("/Users/jpchatain/Documents/dev/Perso/project-why/repo/cs50-c/res/passwd", computed_file_content);
